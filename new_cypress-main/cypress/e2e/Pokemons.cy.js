describe('Покупка аватара', function () {                                // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[type="email"]').type('serqqq161@yandex.ru');                   // вводим логин
         cy.get('input[type="password"]').type('Utasum1');               // вводим пароль
         ...
         cy.get('.k_input_ccv').type('125');                             //npx cypress open вводим CVV карты
